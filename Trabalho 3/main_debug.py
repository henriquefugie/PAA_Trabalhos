...
def cruzada(vetor, inicio, meio, fim):
    ...
    print(f"Cruzamento sendo feito com os seguintes pontos: inicio - {inicio} meio - {meio} fim - {fim}\n")
...
def maiorSubArrayRecursivo(vetor, inicio, fim):
    ...
    print(f"O subarray encontrado pela parte da esquerda foi: {esquerda}")
    print(f"O subarray encontrado pela parte da direita foi: {direita}")
    print(f"O subarray encontrado pela parte do cruzamento foi: {cruzamento}\n")
